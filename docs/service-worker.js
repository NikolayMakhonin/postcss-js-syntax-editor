...
},ASSETS="cache".concat(1552240603884),to_cache=["client/chunk.da4dee67.js","client/chunk.39972887.js","client/chunk.c5253fd4.js","client/chunk.98ca78f2.js","client/chunk.107ec70d.js","client/chunk.e0da52c1.js","client/client.f77ec556.js","client/chunk.42be813d.js","client/chunk.09f27a39.js"].concat(["/service-worker-index.html","favicon.png","global.css","great-success.png","manifest.json","polyfills/bundle.js","styles.css","styles.css.map","svelte-logo-192.png","svelte-logo-512.png"]),cached=new Set(to_cache)
...
;url.protocol.startsWith("http")&&(url.hostname===self.location.hostname&&url.port!==self.location.port||(url.host===self.location.host&&cached.has(url.pathname)?event.respondWith(caches.match(event.request)):"only-if-cached"!==event.request.cache&&event.respondWith(caches.open("offline".concat(1552240603884)).then(function(){
