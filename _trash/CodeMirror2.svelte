<script context="module">
	...
	if (process.browser) {
		codemirror_promise = import(/* webpackChunkName: "codemirror" */ '../src/components/_codemirror.js')
...
<script>
	/* eslint-disable no-shadow,no-use-before-define,no-lone-blocks,no-undef */

	import {
		onMount, beforeUpdate, createEventDispatcher, getContext
	} from 'svelte'
	...
	export const errorLoc = null
	export const flex = false
	export const lineNumbers = true
